...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname arithmetic-expression) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
